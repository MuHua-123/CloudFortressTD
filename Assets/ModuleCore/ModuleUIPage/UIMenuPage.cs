...
public class UIMenuPage : ModuleUIPage {
	...
	private void Awake() {
		Button1.clicked += () => ModuleUI.Jump(DataPage.Scene);
		Button2.clicked += () => { };
		Button3.clicked += () => ModuleUI.Jump(DataPage.Settings);
	...
	private void ModuleUI_OnJumpPage(DataPage page) {
		Element.EnableInClassList("document-page-hide", page != DataPage.Menu);
	}
}
