...
/// 炮塔数据
/// </summary>
public class DataTurretOld {
	/// <summary> 预设数据 </summary>
	public readonly ConstTurretOld presets;
	/// <summary> 初始化 </summary>
	public DataTurretOld(ConstTurretOld presets) => this.presets = presets;
	...
	public ModulePrefab<DataTurretOld> visual;
}
public static class DataTurretTool {
	/// <summary> 更新炮塔属性 </summary>
	public static void UpdateProperty(this DataTurretOld turret) {
		//炮塔基础等级属性
	...
	public static DataBullet ToBullet(this DataTurretOld turret, Transform prefab, PrefabMonster target, Vector3 position) {
