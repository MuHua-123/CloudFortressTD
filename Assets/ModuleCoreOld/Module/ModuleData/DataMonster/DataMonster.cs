...
/// 怪物数据
/// </summary>
public class DataMonsterOld {
	/// <summary> 常量 </summary>
	public readonly ConstMonster constMonster;
	/// <summary> 初始化 </summary>
	public DataMonsterOld(ConstMonster constMonster) => this.constMonster = constMonster;

	/// <summary> 怪物预制 </summary>
	public Transform Prefab => constMonster.prefab;
	/// <summary> 可视化内容 </summary>
	public ModulePrefab<DataMonsterOld> visual;
	/// <summary> 生命值 </summary>
	public ModulePrefab<DataMonsterOld> hitPoints;
...
public static class DataMonsterTool {
	public static DataDamage To(this DataMonsterOld monster, DataAttack attack) {
	...
	public static void To(this DataMonsterOld monster, DataDefense defense) {
