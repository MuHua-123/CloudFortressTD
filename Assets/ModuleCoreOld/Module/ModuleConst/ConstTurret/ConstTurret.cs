...
public class ConstTurretOld : ScriptableObject {
...
public static class DataTurretPresetsTool {
	...
	public static DataTurretOld To(this ConstTurretOld presets, DataGridMapUnit mapUnit) {
		DataTurretOld turret = new DataTurretOld(presets);
		turret.mapUnit = mapUnit;
		return turret;
	}
	/// <summary> 建造价格 </summary>
	public static int BuildValue(this ConstTurretOld presets) {
		return (presets.Count + 1) * presets.buildValue;
	}
	/// <summary> 建造价格 </summary>
	public static void BuildCount(this ConstTurretOld presets, int value) {
		presets.Count += value;
